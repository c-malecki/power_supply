...
void Test_LEDs(App_t *app)
{
    ...
    LED_Controller_SetLED(&app->led_controller, LED_STATUS, LED_COLOR_BLUE);
    printf("blue\r\n");
    HAL_Delay(4000);

    LED_Controller_SetLED(&app->led_controller, LED_STATUS, LED_COLOR_YELLOW);
    printf("yellow\r\n\n");
    HAL_Delay(4000);
    ...
    // // LED_Controller_SetLED(&app->led_controller, LED_3V3, LED_OFF);
    // LED_Controller_SetLED(&app->led_controller, LED_5V, LED_OFF);
    // LED_Controller_SetLED(&app->led_controller, LED_VAR, LED_OFF);
