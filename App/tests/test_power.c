...
void test_var_chan(Power_Controller_t *ctrl)
{
    ...
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_VARIABLE, true);
    ...
    // disable again
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_VARIABLE, false);
...
void test_fixed_chans(Power_Controller_t *ctrl)
{
    ...
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_3V3, true);
    printf("3V3 channel out enabled\r\n");
    Power_Controller_UpdateMainValues(ctrl);
    HAL_Delay(2000);

    // 5V enabled and recheck main power values
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_5V, true);
    ...
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_3V3, false);
    Power_Controller_UpdateMainValues(ctrl);
    HAL_Delay(2000);

    // 5V disabled and recheck main power values
    printf("5V channel out disabled\r\n\n");
    Power_Controller_EnableOut(ctrl, POWER_CHANNEL_5V, false);
    Power_Controller_UpdateMainValues(ctrl);
    HAL_Delay(2000);
}
