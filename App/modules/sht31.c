...
_Error_Codes SHT_StartRead(I2C_HandleTypeDef *i2c_handle)
{
    ...
    return ConvHALError(HAL_I2C_Master_Transmit(i2c_handle, SHT_I2C_ADDRESS, cmd, 2, 100));
}
...
// _Error_Codes SHT_Read_Temperature(I2C_HandleTypeDef *i2c_handle)
// {
//     SHT_Result_t result = { 0 };
//     uint8_t cmd[2] = { SHT_CMD_MEASURE_MSB, SHT_CMD_MEASURE_LSB };

//     result.code = ConvHALError(HAL_I2C_Master_Transmit(i2c_handle, SHT_I2C_ADDRESS, cmd, 2,
//     100)); if (result.code != ERROR_NONE) {
//         return result;
//     }
...
//     uint8_t data[6];
//     result.code = ConvHALError(HAL_I2C_Master_Receive(i2c_handle, SHT_I2C_ADDRESS, data, 6,
//     100)); if (result.code != ERROR_NONE) {
//         return result;
//     }
